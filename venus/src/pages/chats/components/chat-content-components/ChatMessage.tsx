...
interface MessageProps {
    ...
    isCurrentUsers?: boolean; //TODO: delete?
}

export default function ChatMessage({ message, isCurrentUsers }: MessageProps) {
    const isSenderACurrentUser = message.sender.id === 1;

    return (
        // <div
        //     className={`bg-violetDark mr-5 flex w-fit gap-4 px-2 py-2 ${isSenderACurrentUser && "ml-auto"}`}
        // >
        //     <div className="w-10">
        //         <img
