...
export default function BasicSpotWeather() {
    ...
    return (
        data && (
            <div className="dark:bg-violetDarker bg-fifth text-violetDark dark:text-darkText 3xl:right-1/4 absolute top-2 right-1/5 flex items-center space-x-2 rounded-3xl px-3 py-2 text-xl drop-shadow-md dark:drop-shadow-none">
