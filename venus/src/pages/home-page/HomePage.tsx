...
export default function HomePage() {
    ...
    return (
        <div className="dark:bg-darkBg dark:text-darkText bg-lightBg text-lightText flex min-h-screen w-full flex-col items-center space-y-4 overflow-hidden p-8">
