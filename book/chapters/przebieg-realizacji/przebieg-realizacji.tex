...
\begin{itemize}
    ...
    rozwój testów (integracyjnych, jednostkowych i E2E),
    uruchamianie testów w \glslink{cicd}{CI/CD},
...
\begin{itemize}
    ...
    \item \textbf{Multimedia dla \glslink{spot}{spotów}} --
...
\end{itemize}
 ...
 \begin{itemize}
     \item \textbf{Zarządzanie postami przez użytkownika} --
     edycja, usuwanie oraz dodawanie wraz z przypisywaniem kategorii i tagów.

     \item \textbf{Edytor treści} --
     integracja \glslink{rich-text-editor}{edytora rich-text} na potrzeby tworzenia i edycji postów.

     \item \textbf{Multimedia w postach} --
     integracja z \glslink{azure-blob-storage}{Azure Blob Storage} do przesyłania
     i przechowywania mediów.

     \item \textbf{Przeglądanie, sortowanie oraz wyszukiwanie} --
     możliwość sortowania listy postów oraz wyszukiwania postów z wykorzystaniem filtrów.

     \item \textbf{Zarządzanie komentarzami przez użytkownika} --
     dodawanie, edycja oraz usuwanie postów przez użytkownika.

     \item \textbf{Głosowanie} --
     możliwość głosowania na posty oraz komentarze.

     \item \textbf{Zgłaszanie treści} --
     możliwość zgłaszania postów i komentarzy jako nieodpowiednich.

     \item \textbf{Obserwowanie postów} --
     możliwość obserwowania wybranych postów.

     \item \textbf{Udostępnianie postów} --
     możliwość udostępniania postów poprzez link.

     \item \textbf{Top 3 posty miesiąca} --
     prezentacja trzech najpopularniejszych postów z danego miesiąca.

     \item \textbf{Regulamin forum} --
     udostępnienie regulaminu forum.
 \end{itemize}
...
Końcowy okres realizacji koncentrował się na finalizacji implementacji funkcjonalności
