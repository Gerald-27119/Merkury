...
ze specyfiki specjalizacji „Aplikacje Internetowe”, na której studiują
wszyscy członkowie zespołu.

\subsection*{Lipiec 2024}

\begin{zadaniaosoby}{Cały zespół}
    \item Określenie struktury plików na \gls{backend}
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Przygotowanie lokalnego środowiska deweloperskiego dla \gls{backend}u
...
\begin{zadaniaosoby}{Cały zespół}
    ...
    podstawowego workflow z wykorzystaniem \gls{tablica_kanban}.
\end{zadaniaosoby}

\begin{zadaniaosoby}{Mateusz Redosz}
    \item Konfiguracja biblioteki \gls{tailwind-css} w aplikacji
    frontendowej, co umożliwiło spójne i responsywne stylowanie
    komponentów.
    \item Konfiguracja narzędzia \gls{prettier} do automatycznego
    formatowania kodu frontendu i ujednolicenia stylu zapisu.
    \item Implementacja logiki rejestracji użytkownika po stronie
    backendu, obejmującej walidację danych wejściowych oraz obsługę
    błędów na poziomie API.
    \item Dodanie i konfiguracja biblioteki \gls{tanstack-query}
    do obsługi komunikacji z backendem i cachowania danych po stronie
    frontendu.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Cały zespół}
    \item Stabilizacja modułu uwierzytelniania oraz środowiska
    uruchomieniowego na podstawie doświadczeń z pierwszych wdrożeń
...
\begin{zadaniaosoby}{Mateusz Redosz}
    ...
    \item Przygotowanie struktury rozdziału  \textit{Nakład pracy}
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Opracowanie rozdziału~\hyperref[ch:analiza-wymagan]{\ref*{ch:analiza-wymagan}\ \textit{\nameref*{ch:analiza-wymagan}}}
    – przygotowanie listy aktorów systemu, diagramów przypadków użycia oraz scenariuszy przypadków użycia.
\end{zadaniaosoby}
...
%TODO: do uzupełnienia w grudniu
TODO: do uzupełnienia w grudniu

\subsection*{Grudzień 2025}

%TODO: do uzupełnienia w styczniu
TODO: do uzupełnienia w styczniu

\subsection*{Styczeń 2026}

%TODO: do uzupełnienia na koniec
TODO: do uzupełnienia na koniec
