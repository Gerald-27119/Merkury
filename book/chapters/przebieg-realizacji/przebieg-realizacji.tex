...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Implementacja podstawowej strony powitalnej na frontendzie.
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Dodanie docker-compose dla backendu i bazy danych.
...
\begin{zadaniaosoby}{Mateusz Redosz}
    ...
    \item Poprawa logiki obsługi JWT.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Zaprezentowanie zespołowi przykłądowych testów integracyjnych oraz E2E na backendzie.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    ...
    i GitHub po stronie backendu oraz integracja z frontendem.
    \item Napisanie testów na backendzie do \gls{oauth}.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Mateusz Redosz}
    \item Dalsze poprawki obsługi \gls{jwt} na backendzie oraz dodanie logowania
    błędów związanych z procesem logowania i rejestracji.
    \item Implementacja przykładowych testów E2E na frontendzie.
\end{zadaniaosoby}

\begin{zadaniaosoby}{Stanisław Oziemczuk}
    \item Poprawa logiki logowania użytkownika po stronie backendu i frontendu.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Zaprezentowanie zespołowi działania testów integracyjnych oraz E2E na backendzie.
...
\begin{zadaniaosoby}{Mateusz Redosz}
    ...
    \item Poprawa sposobu wyświetlania szczegółów spota.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    ...
    po stronie backendu.
    \item Implementacja logiki zmiany danych konta użytkownika zarówno na backendzie jak i na frontendzie.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    ...
    \item Testy Integracyjne logiki logowania i rejestracji oauth na backendzie oraz filtrowania spotów.
...
\begin{zadaniaosoby}{Adam Langmesser}
    ...
    \item Poprawa działania ci/cd dla backendu.
    \item Poprawa struktury plików na backendzie.
    \item Dodanie cachowania na backendzie w postaci Redis.
    \item Poprawa konfiguracji poziomów logowania o błędach na backendzie.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Kacper Badek}
    ...
    edycji, usuwania i głosowania na komentarze spota oraz lepsza integracja
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Konfiguracja projektu dokumentacji w LaTeX,
    ...
    backendowej i frontendowej, a także dostosowanie layoutu i paska bocznego
    do nowej sekcji.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Mateusz Redosz}
    ...
    usprawnienie nawigacji z kart znajomych i sidebaru oraz aktualizacja testów.
...
\begin{zadaniaosoby}{Mateusz Redosz}
    ...
    starych endpointów edycji danych oraz dodanie zależności potrzebnych do obsługi formularzy.
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    \item Zastąpienie dotychczasowych filtrów wyszukiwania spotów na mapie nowym paskiem wyszukiwania po nazwie
    z bocznym panelem wyników i paginacją oraz dopracowanie interfejsu
    (gwiazdki ocen) i logiki cache'owania zapytań.
    \item Ujednolicenie obsługi mediów dla spotów i komentarzy oraz
    implementacja wyświetlania zdjęc i filmów dla spotów.
    \item Refaktoryzacja struktury plików na backendzie związanych
    z modułem mapy.
    \item Dodanie możliwości wyszukiwania spotów na mapie w obecnie widocznym dla użytkownika obszarze.
    \item Dodanie zdjęć i filmów do spotów w celach deweloperskich.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Adam Langmesser}
    ...
    obrazów (GIF) oraz wysyłania emoji.
    \item Usprawnienie czatu poprzez wprowadzenie optymistycznego
    wysyłania wiadomości, dodanie nowych endpointów
    do stronicowanego pobierania starszych wiadomości.
\end{zadaniaosoby}

\begin{zadaniaosoby}{Stanisław Oziemczuk}
    \item Dodanie jednoznacznego „punktu środka” spota i konsekwentne wykorzystywanie
    go w backendzie i frontendzie.
\end{zadaniaosoby}

\begin{zadaniaosoby}{Mateusz Redosz}
    \item Dodanie na stronie głównej karuzeli z najpopularniejszymi
    spotami oraz wyszukiwarki spotów po lokalizacji, z listą wyników i dystansem od użytkownika.
    ...
    spotów oraz widoku listy dodanych spotów.
\end{zadaniaosoby}
...
\begin{zadaniaosoby}{Adam Langmesser}
    ...
    \item Dodanie obsługi emoji na czacie oraz poprawa wyglądu okna do wysyłania GIFów
\end{zadaniaosoby}

\begin{zadaniaosoby}{Mateusz Redosz}
    \item Refaktoryzacja systemu informacji o błędach i sukcesach na frontendzie, umożliwiająca
    jednoczesne wyświetlanie wielu komunikatów oraz zwiększająca
    modularność i możliwość ponownego wykorzystania komponentów.
    \item Wprowadzenie paginacji dla wyszukiwarki spotów.
