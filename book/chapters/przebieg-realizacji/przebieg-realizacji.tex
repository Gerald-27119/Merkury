...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Zaprezentowanie zespołowi działania \glslink{integration-tests}{testów integracyjnych}
    oraz \glslink{e2e-tests}{testów E2E} na \glslink{backend}{backendzie}.
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    ...
    \item Drobna refaktoryzacja kodu na \glslink{frontend}{frontendzie}.
...
\begin{zadaniaosoby}{Stanisław Oziemczuk}
    ...
    komponentami UI, uporządkowanie warstwy \gls{api} oraz poprawa wyglądu
...
\begin{zadaniaosoby}{Kacper Badek}
    ...
    \item Wprowadzenie czytelniejszych adresów \gls{url} opartych na \gls{slug}ach,
