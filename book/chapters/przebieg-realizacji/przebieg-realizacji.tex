...
\begin{itemize}
    ...
    oraz minimalną strukturę modułów (\textbf{cały zespół}).
...
\begin{itemize}
    ...
    oraz w postaci wykresu Gantta (\textbf{cały zespół}).
    TODO: odwołanie do rozdziału z harmonogramem projektu.
    \item Przygotowanie wstępnych założeń i wymagań
    w ramach przedmiotu PRO (\textbf{cały zespół}).
    ...
    możliwości interaktywnej mapy (\textbf{Adam Langmesser}).
    Ze względu na ograniczone możliwości customizacji wyglądu
    biblioteki zdecydowano się później na zmianę dostawcy
    kafelków mapowych na usługę \textit{TODO: uzupełnić nazwę
    docelowej usługi mapowej}.
    ...
    dla użytkownika (\textbf{Stanisław Oziemczuk}).
...
\begin{itemize}
    ...
    \item Dodanie biblioteki Redux do frontendu i wstępna
    konfiguracja store (\textbf{Mateusz Redosz}).
    ...
    z bezpieczeństwem (scenariusze logowania i rejestracji użytkownika
    po stronie backendu) (\textbf{Adam Langmesser}).
\end{itemize}
...
TODO: do uzupełnienia – opis prac wykonanych we wrześniu 2025 roku
...
TODO: do uzupełnienia – opis prac wykonanych w październiku 2025 roku
...
\begin{itemize}
    ...
    przypadków użycia (\textbf{Adam Langmesser}).
...
TODO: do uzupełnienia – szczegółowy opis ostatnich prac wykonanych
