...
\begin{zadaniaosoby}{Adam Langmesser}
    ...
    oraz przygotowanie inicjalnych danych w bazie danych.
...
\end{zadaniaosoby}
%TODO: doatkowo srpawdz swoje zadnaia i stachowe
\begin{zadaniaosoby}{Adam Langmesser}
...
\begin{zadaniaosoby}{Adam Langmesser}
    \item Dodanie szczegółowego pobierania danych czatu i wysyłania wiadomości po \gls{websocket}.
    ...
    dodatkowych poprawek ergonomii.
...
\begin{zadaniaosoby}{Adam Langmesser}
    ...
    do stronicowanego pobierania wiadomości.
\end{zadaniaosoby}
