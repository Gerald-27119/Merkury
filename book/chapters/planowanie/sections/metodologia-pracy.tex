...
Do zarządzania zadaniami zastosowana została \textbf{Jira} (monitorowanie postępu prac oraz ewidencja zadań członków zespołu). Komunikację w zespole zaplanowano w formie regularnych spotkań oraz asynchronicznie z wykorzystaniem \textbf{Discorda} oraz \textbf{Messengera}.
