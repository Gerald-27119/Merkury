...
\newcounter{riskcard}[chapter]
\renewcommand{\theriskcard}{\thechapter.\arabic{riskcard}}

\newcommand{\riskcard}[6]{
    \refstepcounter{riskcard}
    \begin{center}
    ...
    \end{tabularx}
    \vspace{3pt}
    \textbf{Tabela \theriskcard:} Karta analizy ryzyka: #2\label{#1}
    \end{center}
    \addcontentsline{lot}{table}{Tabela \theriskcard: Karta analizy ryzyka: #2}
}
