...
% --- Licznik kart usług zewnętrznych ---
...
\newcommand{\integrationcard}[5]{%
    ...
    \rowcolor{lightgray}
    \multicolumn{2}{|c|}{\textbf{KARTA USŁUGI ZEWNĘTRZNEJ}} \\ \hline
    \textbf{Nazwa:} & #2 \\ \hline
    \textbf{Opis:}  & #3 \\ \hline
    \textbf{Limit:} & #4 \\ \hline
    \end{tabularx}
...
Niniejszy rozdział zawiera spis zewnętrznych \gls{api} oraz usług użytych w projekcie.
...
{OpenFreeMap~\cite{openfreemap-docs}}
