...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Nie manipuluje bezpośrednio DOM, lecz tworzy swój wirtualny DOM i porównuje jego wersje.
        Po wykryciu zmian aktualizuje tylko te części DOM, które tego wymagają, co przekłada się na wydajną interakcję z apliklacją.
        Często jest wykorzystywany do tworzenia aplikacji typu SPA.
    \end{itemize}
\end{itemize}
