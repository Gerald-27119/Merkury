...
\begin{itemize}
    ...
    Narzędzie umożliwiające wykonywanie testów \glslink{integration-tests}{integracyjnych} oraz
    \glslink{e2e-tests}{E2E} \glslink{frontend}{frontendowej} częsci aplikacji webowej.
    W projekcie zastosowano je do stworzenia i uruchomienia testów \glslink{e2e-tests}{E2E}.
\end{itemize}
