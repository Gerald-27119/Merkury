...
Do niektórych płatnych narzędzi mieliśmy bezpłatny dostęp za pośrednictwem uczelni, w innych mogliśmy założyć konta
edukacyjne, które oferowały dostęp do wszystkich funkcji narzędzia.
...
\begin{itemize}
    ...
    Używaliśmy go do programowania zarówno \glslink{frontend}{frontendu}, jak i \glslink{backend}{backendu} oraz tworzenia dokumentacji w LaTeX.
    ...
    Wykorzystywaliśmy je do lokalnego uruchamiana bazy danych oraz serwisu do cachowania.
    \item \textbf{One Drive}

    Usługa dysku chmurowego oferowana przez firmę Microsoft.
    Przechowywaliśmy tam dokumenty oraz obrazy diagramów.
    ...
    Wykorzystaliśmy go do przechowywania zdjęć profilowych użytkownika oraz multimedii (zdjęcia i filmy) ze spotów
    i forum.
    \item \textbf{Jira}
    ...
    Do każdego zadania tworzyliśmy osobną gałąź z właściwą nazwą, a po zakończeniu prac przeprowadzaliśmy \glslink{review-kodu}{review kodu}.
    ...
    Wykorzystywaliśmy go podczas \glslink{review-kodu}{review codu}.
    ...
    Stosowaliśmy go do spotkań, na których omawialiśmy sprawy dotyczące projektu.
    ...
    Zrobiliśmy w nim diagram przypadków użycia.
    \item \textbf{Xmind}
