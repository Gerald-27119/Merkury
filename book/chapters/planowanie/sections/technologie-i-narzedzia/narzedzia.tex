...
\begin{itemize}
    ...
    Wykorzystywano je do lokalnego uruchamiana bazy danych oraz serwisu do cachowania.
    ...
    Wykorzystywano go do przechowywania zdjęć profilowych użytkownika oraz multimedii (zdjęcia i filmy) ze \glslink{spot}{spotów}
    i forum.
    \item \textbf{Jira}
    ...
    Wykorzystywano go podczas \glslink{review-kodu}{review codu}.
