...
\begin{itemize}
    ...
    \item \textbf{administrator} – odpowiedzialny za moderowanie treści publikowanych w aplikacji
\end{itemize}

Diagram przedstawia również sposób generowania przychodów przez aplikację,
oparty na wyświetlaniu reklam.
