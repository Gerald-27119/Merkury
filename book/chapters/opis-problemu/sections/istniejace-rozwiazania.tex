...
DroneMap PANSA~\cite{dronemap} jest oficjalną mapą przestrzeni powietrznej
...
Dronestagram~\cite{dronestagram} jest platformą internetową, która częściowo
...
Rozwiązanie to nie oferuje jednak możliwości dodawania i oceniania \glslink{spot}{spotów} do latania,
