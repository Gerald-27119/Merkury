...
\begin{center}
    \textbf{Tabela \thestakeholder:} Aspekty biznesowe projektu.
\end{center}
\label{tab:business-aspects}
\addcontentsline{lot}{table}{Tabela \thestakeholder: Aspekty biznesowe projektu.}