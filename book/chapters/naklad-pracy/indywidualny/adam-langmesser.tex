...
równolegle przygotowując demonstracyjny prototyp mapy z wykorzystaniem biblioteki \gls{leaflet}, a także skonfigurowałem zabezpieczenia po stronie \glslink{serwer}{serwera},
dopracowując \gls{spring-security} w zakresie reguł autoryzacji oraz własnych filtrów. Wdrożyłem mechanizm cachowania z użyciem \gls{redis}.

Równolegle przygotowałem podstawy pod procesy \gls{cicd} dla części \glslink{serwer}{serwerowej} (w tym kluczowe kroki budowania i uruchamiania testów).
