...
Na realizację projektu poświęciłem łącznie 455 godzin, z czego:
\begin{itemize}
    \item 49 godz. \textendash \space przygotowanie widoków w Figmie
    \item 270 godz. \textendash \space prace deweloperskie
    \item 100 godz. \textendash \space przygotowanie dokumentacji
    \item 36 godz. \textendash \space przeprowadzenie \glslink{review-kodu}{review kodu}
\end{itemize}
...
W ramach tworzenia dokumentacji naszej pracy inżynierskiej byłem odpowiedzialny za napisanie następujących
rozdziałów oraz podrozdziałów:
