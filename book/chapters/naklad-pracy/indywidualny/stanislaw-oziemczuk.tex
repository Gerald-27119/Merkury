...
\begin{itemize}
    \item 37 godz. 11 min. \textendash \space zaprojektowanie \glslink{ui}{UI} modułu czatu w figmie
...
Po zaprojektowaniu interfejsu użytkownika zostałem odpowiedzialny za całościową implementację modułu mapy.
W ramach prac wybrałem nowego dostawcę kafelków mapy, na którą następnie naniosłem \glslink{spot}{spoty} wraz z możliwością
