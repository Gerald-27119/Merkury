...
\begin{itemize}
    ...
    \item projektowanie struktury aplikacji, w tym struktury bazy danych oraz interfejsu użytkownika
    \item implementację modułu mapy umożliwiającego przeglądanie, ocenianie oraz komentowanie spotów do latania dronem
    ...
    \item implementację modułu profilu użytkownika umożliwiającego tworzenie i edycję profilu, dodawanie własnych spotów
