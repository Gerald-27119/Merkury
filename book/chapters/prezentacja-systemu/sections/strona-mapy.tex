...
\begin{itemize}
    ...
    pamięci podręcznej systemu o czym informuje odpowiedni komunikat (rys. \ref{fig:spot-share}); wklejenie go w pasek przeglądarki
...
%    \caption{Formularz umożliwiający dodanie komentarza do spota w ciemnym motywie.}
