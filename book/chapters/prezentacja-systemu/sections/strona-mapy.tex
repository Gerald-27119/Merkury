...
\begin{itemize}
    ...
    Jeżeli żadne multimedia nie zostaną dołączone, wysłanie formularza będzie niemożliwe i zostanie wyświetlona informacja o błędzie (rys. \ref{fig:spot-add-media-form-error}).
