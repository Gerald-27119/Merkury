...
dostawców (Google oraz GitHub), co umożliwia uwierzytelnienie bez podawania danych konta lokalnego.
...
Analogicznie do logowania, dostępna jest rejestracja z użyciem zewnętrznych dostawców (Google oraz GitHub),
