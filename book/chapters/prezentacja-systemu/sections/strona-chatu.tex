...
znajdują się skróty do otwarcia paneli GIFów lub emoji. Na prawo od nich jest przycisk wysyłania wiadomości.
...
Rysunek~\ref{fig:chat:group-edit-3} przedstawia efekt wysłania GIF-a.
...
Po naciśnięciu ikony reprezentującej emoji otwierany jest panel w formie nakładki, analogiczny do panelu wyboru GIF-ów.
...
Z kolei, jeżeli wysłanym załącznikiem jest plik multimedialnym
prezentowana jest miniatura jego podglądu.
...
(przy aktywnej konwersacji prywatnej). Po jego użyciu interfejs wyświetla okno modalne,
...
Naciśnięcie kafelka powoduje otwarcie okna modalnego pozwalającego edytować czat grupowy.
...
Po użyciu tej akcji wyświetlane jest okno modalne, a widok czatu w tle zostaje przyciemniony.
