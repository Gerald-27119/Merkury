...
\cardendpoint {EP01} {/public/user-dashboard/profile/ \newline \{targetUsername\}} {Pobierz profil innego użytkownika (widok publiczny)} {%
    \begin{tabitemize}
...
\cardendpoint {EP05} {/user-dashboard/add-spot} {Dodaj nowy spot użytkownika} {%
    \begin{tabitemize}
        ...
        \item \textbf{media}: List<MultipartFile> (część multipart, pliki multimedialne spota)
    \end{tabitemize}
