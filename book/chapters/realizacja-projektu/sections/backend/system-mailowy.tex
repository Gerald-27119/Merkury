...
Do obsługi wysyłania wiadomości zastosowano \glslink{biblioteka}{bibliotekę} JavaMail (Jakarta Mail).
...
W przypadku niepowodzenia przesłania wiadomości na jednym porcie system podejmuje próbę ponownego wysłania przy użyciu kolejnych portów.
Dane uwierzytelniające do serwera SMTP pobierane są z poziomu zmiennych środowiskowych, co zwiększa poziom bezpieczeństwa i eliminuje konieczność ich przechowywania w repozytorium kodu.
...
\begin{figure}[H]
    ...
    \caption{Implementacja metody odpowiedzialnej za asynchroniczne wysłanie wiadomości e-mail}
