...
klienta dostawcy, serwis aplikacyjny oraz kontroler \glslink{rest_api}{REST}.
...
za bezpośrednią komunikację z \glslink{api}{API} Tenor. Klient wykorzystuje \glslink{webclient}{WebClient'a},
...
Rysunek~\ref{fig:gif:controller} przedstawia kontroler REST udostępniający funkcjonalności \glslink{gif}{GIF-ów}
