...
\glslink{docker-compose}{Docker Compose} (rys. \ref{img:docker-compose}), dzięki czemu wystarczy użyć jednego
pliku konfiguracyjnego, a wszystkie wymagane usługi zostają automatycznie uruchomione z odpowiednimi ustawieniami.
