...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Portal} \textemdash \space to wyświetlanie komponentów poza drzewem \glslink{dom}{DOM} rodzica (komponentu nadrzędnego).
        Wykorzystywane jest to, gdy komponent musi być wyświetlony "nad" innymi elementami \glslink{ui}{UI}
