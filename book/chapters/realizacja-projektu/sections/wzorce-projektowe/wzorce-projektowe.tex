...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \end{figure}
        \noindent
        W projekcie skorzystano z \glslink{framework}{frameworka} Spring Boot, w którym wszystkie klasy oznaczone jako Beany
        są Singletonami.
        Przykładem jest nadanie klasie adnotacji \emph{@Service}.
        Raz stworzony obiekt jest wykorzystywany przez wszystkie inne potrzebujące go obiekty.

        Poniżej przedstawiono wykorzystanie adnotacji \emph{@Service} oraz użycie tej klasy jako zależność w innej klasie.
        \begin{figure}[H]
                  \centering
        ...
        \end{figure}
        \noindent
        Do zaimplementowania tego \glslink{wzorzec}{wzorca} projektowego wykrzystano adnotację \emph{@Builder} z biblioteki \emph{Lombok},
        ...
        Poniżej przedstawiono zastosowanie adnotacji \emph{@Builder} oraz przykładowe użycie tego wzorca podczas konstruowania encji.
        \begin{figure}[H]
            \centering
