...
\begin{enumerate}
    \item \textbf{Pobranie danych wejściowych} -- odczyt tokenu JWT z żądania.
    \item \textbf{Walidacja} -- sprawdzenie poprawności tokenu. W przypadku błędu filtr przygotowuje odpowiedź
    ...
    \item \textbf{Odświeżenie tokenu (opcjonalnie)} -- gdy czas ważności zbliża się do końca, generowany jest nowy token.
