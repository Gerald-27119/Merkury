...
\textbf{Builder} \textemdash \space kreacyjny \glslink{wzorzec}{wzorzec} projektowy, który ułatwia tworzenie
skomplikowanych obiektów poprzez rozbicie tego procesu na mniejsze, konfigurowalne etapy.
Eliminuje potrzebę korzystania z kontruktorów zawierających wiele parametrów.
Stworzony zostaje obiekt budujący (Budowniczy), który implementuje poszczególne kroki kontrukcji obiektu, a na końcu
