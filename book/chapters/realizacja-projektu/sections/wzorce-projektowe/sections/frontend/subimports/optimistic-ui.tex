...
\glslink{wzorzec}{Wzorzec}, w którym \glslink{ui}{UI} jest aktualizowane
natychmiast po tym gdy użytkownik wykona czynność.
Dzięki jego zastosowaniu zmniejszone jest odczucie opóźnień w działaniu aplikacji oraz
poprawa płynności jej użytkowania.
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatBottomBar (1/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatBottomBar (2/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatBottomBar (3/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatMessagingWindow (1/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatMessagingWindow (2/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatMessagingWindow (3/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu ChatMessagingWindow (4/4)}
