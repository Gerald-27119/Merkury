...
To renderowanie \glslink{react-component}{komponentów} w innym miejscu drzewa \glslink{dom}{DOM} niż wynika to
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu Modal (1/2)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu Modal (2/2)}
