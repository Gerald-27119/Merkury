...
Po pomyślnej autoryzacji użytkownik przekierowywany jest na \glslink{endpoint} \glslink{backend}{backendu}
...
Z tokenu przesłanego przez \texttt{Provider'a} odczytywany jest jego typ (Google lub \glslink{github}{GitHub}) oraz
...
Po sprawdzeniu czy w bazie danych istnieje użytkownik istnieje, wywoływane są odpowiednio metody do logowania lub
rejestracji.
