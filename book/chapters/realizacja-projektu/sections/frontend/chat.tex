...
Komponent \texttt{EmojiWindow} (rys.~\ref{fig:chat:emoji-window-1}) integruje zewnętrzny selektor \glslink{emoji}{emoji}
i umożliwia wyszukiwanie oraz wybór emotikonów.
Po kliknięciu \glslink{emoji}{emoji} komponent dopisuje go do aktualnie budowanej treści wiadomości.
