...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{ChatBottomBar} (1/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{ChatBottomBar} (2/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{ChatBottomBar} (3/4)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{ChatBottomBar} (4/4)}
    \label{fig:chat:bottom-bar-4}
\end{figure}

\glslink{react-component}{Komponent} \texttt{ChatBottomBar} (rys.~\ref{fig:chat:bottom-bar-1}--\ref{fig:chat:bottom-bar-4}) realizuje wysyłanie wiadomości tekstowych,
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{GifWindow} (1/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{GifWindow} (2/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu \texttt{GifWindow} (3/3)}
    \label{fig:chat:gif-window-3}
\end{figure}

\glslink{react-component}{Komponent} \texttt{GifWindow} (rys.~\ref{fig:chat:gif-window-1}--\ref{fig:chat:gif-window-3}) umożliwia wyszukiwanie oraz wysyłanie \glslink{gif}{GIF-ów}
