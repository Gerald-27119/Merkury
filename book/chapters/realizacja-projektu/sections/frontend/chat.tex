...
Komponent \texttt{ChatList} (rys.~\ref{fig:chat:chat-list-1}--\ref{fig:chat:chat-list-4}) odpowiada za pobieranie oraz prezentację listy rozmów użytkownika.
...
Komponent \texttt{ChatTopBar} (rys.~\ref{fig:chat:top-bar-1}--\ref{fig:chat:top-bar-6}) pełni rolę nagłówka konwersacji.
