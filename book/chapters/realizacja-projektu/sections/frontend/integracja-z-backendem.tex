...
stanów zapytania (takich jak ładowanie danych, błąd, sukces). \glslink{biblioteka} udostępnia m.in.
...
Dodatkowo \gls{hook} \texttt{useQuery} z tej \glslink{biblioteka}{Biblioteki} umożliwia automatyczne pobieranie danych po wejściu na daną podstronę.
