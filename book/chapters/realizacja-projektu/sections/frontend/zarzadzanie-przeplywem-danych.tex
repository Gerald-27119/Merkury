\usepackage{glossaries}%! Author = Mateusz
%! Date = 20/10/2025
...
(za pomocą \gls{hook}a \texttt{useState})~\cite{react-use-state}, jak i ze \gls{stan}u globalnego,
...
(lub jego najbliższych elementów podrzędnych), wykorzystujemy \gls{hook} \texttt{useState}.
...
powstały \gls{hook}i niestandardowe, takie jak \texttt{useScreenSize},
...
Z racji tego, że korzystamy z \gls{react}a w połączeniu z \gls{type-script}em,
przygotowaliśmy również własne \gls{hook}i wspomagające typowanie, takie jak
