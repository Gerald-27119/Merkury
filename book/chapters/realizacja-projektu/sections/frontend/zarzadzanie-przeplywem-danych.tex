...
Niniejszy podrozdział opisuje zastosowane w projekcie podejście do zarządzania \glslink{stan}{stanem}
oraz organizację przepływu danych w aplikacji frontendowej. \newline

W projekcie postawiliśmy na zrównoważone podejście do zarządzania \glslink{stan}{stanem}.
Korzystamy zarówno z lokalnego \glslink{stan}{stanu} komponentów
...
Globalny \glslink{stan}{stan} został wprowadzony po to, aby możliwie najbardziej ograniczyć
...
(lub jego najbliższych elementów podrzędnych), wykorzystujemy \glslink{hook}{hook} \texttt{useState}.
...
\texttt{useDarkMode} czy \texttt{useClickOutside}.
Dzięki temu większość logiki prezentacji została wydzielona
...
przygotowaliśmy również własne \glslink{hook}{hooki} wspomagające typowanie, takie jak
