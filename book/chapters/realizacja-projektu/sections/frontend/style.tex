...
Niniejszy podrozdział przedstawia zastosowane w projekcie rozwiązania dotyczące stylowania interfejsu użytkownika
oraz narzędzia wykorzystywane do tworzenia spójnej i \glslink{responsywnosc}{responsywnej} warstwy wizualnej aplikacji. \newline

Do stylowania interfejsu wykorzystaliśmy \glslink{framework}{framework} Tailwind CSS~\cite{tailwind}.
...
W pliku \texttt{index.css} zdefiniowaliśmy zmienne kolorystyczne (rys. \ref{img:css-kolory1} i \ref{img:css-kolory2}).
...
W naszej aplikacji użyliśmy jej m.in. w polach formularza logowania i rejestracji (rys. \ref{img:motion}).
