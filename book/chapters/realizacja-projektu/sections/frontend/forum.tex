...
Komponent pozwalający wybrać sposób sortowania listy postów lub komentarzy (rys. \ref{img:forum-sort-dropdown}).
...
Komponent stanowiący warstwę integracyjną pomiędzy React Hook Form a \glslink{rich-text-editor}{edytorem rich text} opartym o \glslink{tiptap}{bibliotekę Tiptap} (rys. \ref{img:controlled-editor}).
...
Komponent oparty o \glslink{react-select}{bibliotekę react-select}, umożliwiający wybór pojedynczych lub wielu wartości z listy z obsługą wyszukiwania (rys. \ref{img:select-with-search-1}~\ref{img:select-with-search-2}).
...
Współdzielony komponent menu kontekstowego, wykorzystywany w postach oraz komentarzach (rys. \ref{img:forum-content-menu-1}~\ref{img:forum-content-menu-2}).
