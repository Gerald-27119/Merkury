...
W trybie prostym prezentowana jest karuzela (rys. \ref{img:implementacja-karuzela-spotow}) z dwunastoma najpopularniejszymi \gls{spot}ami w całej aplikacji.
...
a zmiany w sposobie prezentacji \gls{spot}ów wymagają modyfikacji tylko w komponentach współdzielonych.
