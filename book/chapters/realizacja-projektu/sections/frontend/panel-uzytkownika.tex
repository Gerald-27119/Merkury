...
W obu jest używany reużywalny komponent Profile dzięki czemu widok w większości jest identyczny, własnego profilu
...
Są również cztery przyciski wraz z liczbą statystyk.
Słóżą one do przejścia do znajomych, obserwowanych, obserwujących oraz zdjęć danego użytkownika.
Na samym dole znajduje się lista czterach najpopularniejszych zdjęć danego użytkownika
wraz z informacją o jego.
