...
Do modyfikacji listy wykorzystywana jest \glslink{mutacja}{mutacja} obsługująca dodawanie i usuwanie spotów z danej kategorii.
...
Wyświetlane są: zdjęcie profilowe, nazwa użytkownika oraz zestaw przycisków akcji które służą do przejście do profilu,
otwarcie prywatnego czatu oraz dodanie lub usunięcie z listy znajomych bądź obserwowanych.

Relacje znajomości i obserwowania modyfikowane są za pomocą i\glslink{mutacja}{mutacji} po stronie \glslink{api}{API}, odpowiedzialnych za zarządzanie
...
Po poprawnej walidacji wywoływana jest a\glslink{mutacja}{mutacja} odpowiedzialna za dodanie \glslink{spot}{spota} po stronie \glslink{backend}{backendu}.
