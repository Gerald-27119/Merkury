...
W przypadku błędów zapytania użytkownik otrzymuje stosowną notyfikację, natomiast podczas ładowania wyświetlane są \glslink{react-component}{komponenty} typu skeleton, zapewniające spójne UX\@.
