...
\glslink{react-component}{Komponent} \texttt{ForumSearchBar} odpowiada za zaawansowane wyszukiwanie postów na forum i jest wykorzystywany w \texttt{ForumLayout}.
...
Pobieranie wyników wyszukiwania realizowane jest przy użyciu \glslink{hook}{hooka} \newline \texttt{useInfiniteQuery}, co umożliwia stronicowanie danych oraz dynamiczne ładowanie kolejnych stron.
...
Po wykonaniu wyszukiwania \glslink{react-component}{komponent} \texttt{SearchResults} prezentuje liczbę znalezionych postów oraz czytelne podsumowanie zastosowanych filtrów.
...
\texttt{TrendingPostPanel} wyświetla listę popularnych postów za pomocą \newline \texttt{TrendingPostList}.
