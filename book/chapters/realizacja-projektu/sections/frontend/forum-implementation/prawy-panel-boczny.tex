...
Komponent \texttt{ForumSearchBar} (rys. \ref{img:searchbar-1} - \ref{img:searchbar-4}) odpowiada za zaawansowane wyszukiwanie postów na forum i jest wykorzystywany w \texttt{ForumLayout}.
...
\begin{figure}[H]
    ...
    \caption{Komponent ForumSearchBar (1)}
...
\begin{figure}[H]
    ...
    \caption{Komponent ForumSearchBar (2)}
...
\begin{figure}[H]
    ...
    \caption{Komponent ForumSearchBar (3)}
...
\begin{figure}[H]
    ...
    \caption{Komponent ForumSearchBar (4)}
