...
\glslink{react-component}{Komponent} \texttt{Forum} (rys. \ref{img:forum-komponent}) odpowiada za wyświetlanie strony głównej forum, zawierającej listę postów.
...
W trakcie początkowego ładowania danych wyświetlane są \glslink{react-component}{komponenty} szkieletowe \newline (\texttt{SkeletonListedForumPost}), natomiast w przypadku błędu wyświetlany jest \glslink{react-component}{komponent} \texttt{Error}.
...
\glslink{react-component}{Komponent} \texttt{Post} (rys. \ref{img:post-komponent}) odpowiada za prezentację pojedynczego posta na ich liście.
...
Logika menu została wydzielona do \glslink{react-component}{komponentu} \texttt{ForumContentMenu}, który jest wykorzystywany również w widokach szczegółowych postów oraz komentarzy.
