...
Otrzymuje jego identyfikator z parametrów \glslink{url}{URL} i wykorzystuje \glslink{hook}{hooka} \texttt{useQuery} do pobrania szczegółów \newline (\texttt{DetailedPost}) oraz \texttt{useInfiniteQuery} do stronicowanego pobierania komentarzy.
