...
Komentarze w systemie forum obsługują zagnieżdżone odpowiedzi, co zostało zaimplementowane w formie rekurencyjnego użycia \glslink{react-component}{komponentów}:
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{attachments/implementacja-frontendu/forum/post_comment_1}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{attachments/implementacja-frontendu/forum/post_comment_2}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{attachments/implementacja-frontendu/forum/post_comment_3}
