...
W niniejszym rozdziale przedstawiono implementację panelu logowania po stronie \glslink{frontend}{frontendowej}.
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{Login} (1).}
    \label{img:login1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{Login} (2).}
    \label{img:login2}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{Register} (1).}
    \label{img:register1}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{Register} (2).}
    \label{img:register2}
\end{figure}
...
Układ formularza oparty jest na \texttt{FormContainer}; wewnątrz znajduje się pojedyncze pole
\texttt{FormInput} dla adresu e-mail oraz przycisk potwierdzenia.
Po pomyślnym wysłaniu żądania \texttt{FormContainer} wyświetla komunikat potwierdzający wysłanie wiadomości przypominającej.
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{NewPassword} (1).}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{NewPassword} (2).}
...
\begin{itemize}
    ...
    \item po pomyślnym zakończeniu operacji wyświetlany jest komunikat sukcesu (\texttt{notificationAction.addSuccess}),
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{FormContainer} (1).}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{FormContainer} (2).}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{FormInput} (1).}
...
\begin{figure}[H]
    ...
    \caption{Komponent \texttt{FormInput} (2).}
