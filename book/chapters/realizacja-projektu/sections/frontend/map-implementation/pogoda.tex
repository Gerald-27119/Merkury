...
\textbf{\texttt{DetailedSpotWeather}}
...
Kliknięcie przycisku \texttt{Show more} spowoduje zamknięcie panelu oraz wyświetlenie \glslink{react-component}{komponentu} \texttt{BasicSpotWeather}.
