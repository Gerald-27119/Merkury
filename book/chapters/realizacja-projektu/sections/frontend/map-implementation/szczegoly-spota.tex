...
\textbf{\texttt{SpotCommentVotesPanel}} (rys. \ref{fig:spot-comment-vote-panel-1} - \ref{fig:spot-comment-vote-panel-3})
...
\begin{itemize}
    \item jeśli użytkownił polubił komentarz, ponowwne kliknięcie przycisku usuwua je; analogicznie jest z niepolubieniami
    ...
    \item jeśli uzytkownik nie oddał wcześniej głosu na komentarz, wykonywana jest wybrana akcja
\end{itemize}
Zagłosowanie wymaga zalogowania, o czym informuje komunikat w \glslink{react-component}{komponencie} \texttt{Notification}.
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu SpotCommentVotesPanel (1/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu SpotCommentVotesPanel (2/3)}
...
\begin{figure}[H]
    ...
    \caption{Implementacja komponentu SpotCommentVotesPanel (3/3)}
