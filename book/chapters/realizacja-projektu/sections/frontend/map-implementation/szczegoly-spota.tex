...
Funkcja \texttt{handleClickPhoto} poprzez \glslink{mutacja}{mutację} wysyła na \glslink{backend}
żądanie ustalające pozycję zdjęcia w liście wszystkich zdjęć \glslink{spot}{spota} z uwgzględnieniem sortowania.
