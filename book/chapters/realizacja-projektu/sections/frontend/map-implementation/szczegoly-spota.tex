...
Dodawanie zdjęć i filmów zaimplementowane zostało za pomocą \glslink{react-component}{komponentu}
...
komunikatem.
Wartości wpsisane w poszczególne pola formularzu przechowywane są w lokalnym stanie
