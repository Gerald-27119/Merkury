...
W przypadku błędu w \glslink{react-component}{komponencie} \texttt{Notification} wyświetlany jest komunikat
...
Funkcja \texttt{handleSetMediaFullscreen} obsługuje powiekszenie media na cały ekran poprzez
...
Udostępnienie obsługuje funkcja \texttt{handleClickShare}, która przy użyciu
\texttt{navigator.clipboard.writeText} kopiuje link do wybranego
elementu do pomięci podręcznej systemu użytkownika.
Informacje o stanie zakończenia operacji wyświetlane są w \glslink{react-component}{komponencie}
\texttt{Notification}.
