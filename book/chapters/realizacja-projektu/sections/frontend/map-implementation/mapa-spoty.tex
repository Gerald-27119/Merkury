...
\textbf{\texttt{SearchCurrentViewButton}} (rys. \ref{fig:search-current-view-btn})
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{attachments/implementacja-frontendu/mapa/mapa-spoty/search_current_view_btn}
    \caption{Implementacja komponentu SearchCurrentViewButton}
    \label{fig:search-current-view-btn}
\end{figure}
\noindent
