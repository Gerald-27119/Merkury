...
\usecasecard{tab:pu25-historia-czatu}{Przeszukiwanie historii czatu}{%
    ...
    \ucalt{
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
            \item[4a.] Nie znaleziono wiadomości spełniających kryteria – system informuje o braku wyników wyszukwiania.
        \end{enumerate}
    }
}
...
\usecasecard{tab:pu26-wyslane-pliki}{Przeglądanie wysłanych plików na czacie}{%
    ...
    \ucalt{
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
            \item[4a.] Doszło do błędu podczas pobierania pliku - system wyświetla odpowiedni komunikat.
        \end{enumerate}
    }
}
