...
\usecasecard{tab:pu35-zglos-tresc-forum}{Zgłoszenie treści na forum (post lub komentarz)}{%
    \ucpriority{C}
    \ucactors{Użytkownik}
    \ucdesc{Użytkownik zgłasza treść na forum (post lub komentarz) jako naruszającą regulamin lub tematykę.}
    \ucpre{Użytkownik widzi post lub komentarz w aplikacji.}
    \ucpost{Zgłoszenie treści zostało zapisane i trafiło do kolejki moderacyjnej; treść została oznaczona jako zgłoszona.}
    \ucmain{%
        \begin{enumerate}[nosep,leftmargin=16pt,labelindent=0pt]
            \item Użytkownik wybiera opcję „Zgłoś” dla wybranej treści (posta lub komentarza).
            \item System wyświetla formularz zgłoszenia.
            \item Użytkownik wybiera kategorię naruszenia, podaje szczegóły i potwierdza zgłoszenie.
            \item System zapisuje zgłoszenie, wiąże je z treścią oraz zgłaszającym użytkownikiem i oznacza treść jako zgłoszoną.
        \end{enumerate}
    }
    \ucalt{%
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
            \item[1a.] Użytkownik próbuje zgłosić własną treść – system blokuje operację i wyświetla komunikat, że nie można zgłaszać własnych treści.
            \item[4a.] Treść została już wcześniej zgłoszona – system informuje użytkownika, że treść znajduje się już w kolejce moderacyjnej i nie zapisuje kolejnego zgłoszenia.
        \end{enumerate}
    }
}
