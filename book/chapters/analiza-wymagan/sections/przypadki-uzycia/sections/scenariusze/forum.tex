...
\usecasecard{tab:pu35-zglos-tresc-forum}{Zgłoszenie treści na forum (post lub komentarz)}{%
    \ucpriority{C}
    \ucactors{Użytkownik}
    \ucdesc{Użytkownik zgłasza treść na forum (post lub komentarz) jako naruszającą regulamin.}
    ...
    \ucmain{%
        \begin{enumerate}[nosep,leftmargin=16pt,labelindent=0pt]
            ...
            \item System zapisuje zgłoszenie, wiąże je z treścią oraz zgłaszającym użytkownikiem i oznacza ją jako zgłoszoną
        \end{enumerate}
    }
    \ucalt{%
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
