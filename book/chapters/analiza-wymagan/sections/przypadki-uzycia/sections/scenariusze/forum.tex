...
\usecasecard{tab:pu14-posty-forum}{Przeglądanie postów na forum}{%
    ...
    \ucalt{%
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
            \item[3a.] System nie może pobrać szczegółów posta – system wyświetla komunikat o błędzie.
        \end{enumerate}
    }
}
...
\usecasecard{tab:pu16-dodaj-komentarz}{Dodanie komentarza na forum}{%
    ...
    \ucalt{%
        \begin{enumerate}[nosep,leftmargin=21pt,labelindent=0pt,label={}]
            \item[2a.] Treść komentarza jest niepoprawna – system wyświetla komunikat o błędzie.
        \end{enumerate}
    }
}
...
\usecasecard{tab:pu-forum-przegladaj-komentarze}{Przeglądanie komentarzy pod postem}{%
    ...
    \ucdesc{Użytkownik przegląda komentarze dodane pod wybranym postem na forum.}
    \ucpre{Wyświetlany jest szczegółowy widok posta na forum.}
    \ucpost{Lista komentarzy powiązanych z postem została wyświetlona.}
    \ucmain{%
        \begin{enumerate}[nosep,leftmargin=16pt,labelindent=0pt]
            \item System pobiera komentarze powiązane z wybranym postem.
