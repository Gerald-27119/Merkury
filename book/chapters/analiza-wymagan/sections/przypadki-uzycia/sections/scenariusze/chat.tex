...
\usecasecard{tab:pu-chat-otworz}{Otwarcie czatu}{%
    \ucpriority{Wysoki}
    \ucactors{Użytkownik zalogowany}
    ...
    \ucpost{Wybrany czat został otwarty, a historia rozmowy jest widoczna dla użytkownika.}
    \ucmain{%
        \begin{enumerate}[nosep,leftmargin=16pt,labelindent=0pt]
            ...
            \item System oznacza nieprzeczytane wiadomości w czacie jako przeczytane.
