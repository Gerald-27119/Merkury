...
\begin{table}[H] % to powoduje ze tabelka nie przenosi sie na koniec rozdziału
    \centering
    ...
    \begin{tabularx}{\textwidth}{|L{0.34\textwidth}|X|}
        ...
        Azure Blob Storage & Usługa chmurowa od Microsoftu do przechowywania multimediów m.in: zdjęc spotów, plików wysłąnych na chacie przez użytkowników. \\ \hline
    ...
    \end{tabularx}
    \caption{Aktorzy systemu – przegląd}
    \label{tab:aktorzy}
\end{table}
