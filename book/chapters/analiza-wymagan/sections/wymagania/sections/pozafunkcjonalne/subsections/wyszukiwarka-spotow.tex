...
\settowidth{\wpwyszLabelWidth}{\textbf{Wymagania powiązane:}}
\addtolength{\wpwyszLabelWidth}{-20pt}

\newlength{\wpwyszColTwoWidth}
\newlength{\wpwyszColThreeWidth}
\newlength{\wpwyszColFourWidth}
\setlength{\wpwyszColTwoWidth}{0.31\textwidth}
\setlength{\wpwyszColThreeWidth}{0.18\textwidth}
\setlength{\wpwyszColFourWidth}{0.15\textwidth}

\newlength{\wpwyszContentWidth}
\setlength{\wpwyszContentWidth}{\dimexpr
\wpwyszColTwoWidth+\wpwyszColThreeWidth+\wpwyszColFourWidth\relax}
...
\newcommand{\wpwyszHeaderRow}[1]{%
    \rowcolor{lightgray}%
    \multicolumn{4}{|c|}{%
        \parbox[c][\wpwyszHeaderHeight][c]{\linewidth}{%
            \centering\bfseries
            \vspace{1.2ex}%
            #1%
            \vspace{1.2ex}%
