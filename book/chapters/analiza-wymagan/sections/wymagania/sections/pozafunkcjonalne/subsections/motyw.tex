...
\setlength{\wpmotywContentWidth}{0.7\textwidth}
\addtolength{\wpmotywContentWidth}{20pt}
...
{M}
{
    ...
    \wpmotywaccept{%
        \begin{itemize}
            ...
            \item Preferencja motywu jest stosowana już od pierwszej klatki renderowania UI.
        \end{itemize}
    }
