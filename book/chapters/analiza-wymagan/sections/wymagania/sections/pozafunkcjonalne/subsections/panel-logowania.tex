...
\label{subsubsec:wymagania-pozafunkcjonalne-dla-panelu-logowania-i-rejestracji}


% --- Szerokości ---
\newlength{\wplogLabelWidth}
\setlength{\wplogLabelWidth}{0.2\textwidth}

\newlength{\wplogContentWidth}
\setlength{\wplogContentWidth}{0.74\textwidth}

\newlength{\wplogColTwoWidth}
\newlength{\wplogColThreeWidth}
\newlength{\wplogColFourWidth}
\setlength{\wplogColTwoWidth}{0.22\textwidth}
\setlength{\wplogColThreeWidth}{0.18\textwidth}
\setlength{\wplogColFourWidth}{0.24\textwidth}

\newlength{\wplogHeaderHeight}
\setlength{\wplogHeaderHeight}{12mm}

\newlength{\wplogTableWidth}
\setlength{\wplogTableWidth}{\dimexpr
\wplogLabelWidth+\wplogContentWidth\relax}
...
\newcommand{\wplogHeaderRow}[1]{%
    \rowcolor{lightgray}%
    \multicolumn{4}{|c|}{%
        \parbox[c][\wplogHeaderHeight][c]{\wplogTableWidth}{%
            \centering\bfseries
            \vspace{1.2ex}#1\vspace{1.2ex}%
        }%
    }\\ \hline
}
...
\newcommand{\wplogatcard}[5]{%
    ...
    {%
        ...
        \begin{longtable}{|
            ...
            p{\wplogColTwoWidth}|
                >{\columncolor{lightgray}\raggedright\arraybackslash}p{\wplogColThreeWidth}|
            p{\wplogColFourWidth}|}
        \hline
