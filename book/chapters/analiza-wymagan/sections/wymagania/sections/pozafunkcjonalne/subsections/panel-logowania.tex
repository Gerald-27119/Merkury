...
{S}
{
    ...
    \wplogaccept{%
        \begin{itemize}
            \item W co najmniej 95\% pomiarów czas odpowiedzi API dla logowania i rejestracji mieści się w przedziale 0--10 s.
...
{S}
{
    ...
    \wplogaccept{%
        \begin{itemize}
            \item Identyfikacja sesji nie jest dostępna dla kodu JavaScript w przeglądarce (httpOnly cookie).
...
{S}
{
    ...
    \wplogaccept{%
        \begin{itemize}
            ...
            \item System nie przechodzi do stanu „zalogowany” bez potwierdzenia sukcesu z API.
        \end{itemize}
    }
