...
{S}
{
    ...
    \wpczaccept{%
        \begin{itemize}
            ...
            \item Zapytania do \gls{api} odwołujące się do czatu, którego użytkownik nie jest członkiem, są odrzucane (np.\ kodem 403) i nie zwracają żadnych danych o tym czacie ani jego wiadomościach.
        \end{itemize}
    }
