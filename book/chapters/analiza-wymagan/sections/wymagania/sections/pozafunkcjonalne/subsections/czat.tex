...
\setlength{\wpczColTwoWidth}{0.31\textwidth}
\setlength{\wpczColThreeWidth}{0.18\textwidth}
\setlength{\wpczColFourWidth}{0.15\textwidth}

\newlength{\wpczContentWidth}
\setlength{\wpczContentWidth}{\dimexpr
\wpczColTwoWidth+\wpczColThreeWidth+\wpczColFourWidth\relax}
...
\newcommand{\wpczHeaderRow}[1]{%
    \rowcolor{lightgray}%
    \multicolumn{4}{|c|}{%
        \parbox[c][\wpczHeaderHeight][c]{\linewidth}{%
            \centering\bfseries
            \vspace{1.2ex}%
            #1%
            \vspace{1.2ex}%
