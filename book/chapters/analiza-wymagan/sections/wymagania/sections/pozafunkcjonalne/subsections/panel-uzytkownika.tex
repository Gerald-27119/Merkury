...
\addtolength{\wppanelLabelWidth}{0.2\textwidth}

\newlength{\wppanelContentWidth}
\setlength{\wppanelContentWidth}{0.74\textwidth}

\newlength{\wppanelColTwoWidth}
\newlength{\wppanelColThreeWidth}
\newlength{\wppanelColFourWidth}
\setlength{\wppanelColTwoWidth}{0.22\textwidth}
\setlength{\wppanelColThreeWidth}{0.18\textwidth}
\setlength{\wppanelColFourWidth}{0.24\textwidth}

\newlength{\wppanelHeaderHeight}
\setlength{\wppanelHeaderHeight}{12mm}

\newlength{\wppanelTableWidth}
\setlength{\wppanelTableWidth}{\dimexpr
\wppanelLabelWidth+\wppanelColTwoWidth+\wppanelColThreeWidth+\wppanelColFourWidth\relax}
% --------- Pola karty (wiersze) ---------

\newcommand{\wppanelHeaderRow}[1]{%
    \rowcolor{lightgray}%
    \multicolumn{4}{|c|}{%
        \parbox[c][\wppanelHeaderHeight][c]{\wppanelTableWidth}{%
            \centering\bfseries
            \vspace{1.2ex}%
            #1%
            \vspace{1.2ex}%
...
\newcommand{\wppanelatcard}[5]{%
    ...
    {%
        ...
        \begin{longtable}{|
            ...
            p{\wppanelColTwoWidth}|
                >{\columncolor{lightgray}\raggedright\arraybackslash}p{\wppanelColThreeWidth}|
            p{\wppanelColFourWidth}|}
        \hline
...
\wppanelatcard
{wppanel:photos-authorization}
{Dostęp tylko do własnej listy zdjęć (autoryzacja)}
{13}
{M}
{
    \wppaneltype{Bezpieczeństwo}

    \wppaneldesc{System zapewnia, że użytkownik ma dostęp wyłącznie do własnej listy zdjęć
    powiązanych z kontem i nie może odczytać zdjęć innych użytkowników poprzez panel ani \gls{api}.}

    \wppanelaccept{%
        \begin{itemize}
            \item Lista zdjęć prezentuje wyłącznie materiały dodane przez zalogowanego użytkownika.
            \item Zapytania do \gls{api} o listę zdjęć innego użytkownika są odrzucane (403).
        \end{itemize}
    }
    ...
    \wppanelresponsible{Mateusz Redosz}
    \wppanelrelated{%
        \hyperref[wopanel:photos]{WOPANEL-05},
        \hyperref[wfpanel:photos-sort-by-date]{WFPANEL-10},
        \hyperref[wfpanel:photos-filter-by-date]{WFPANEL-11},
        \hyperref[wfpanel:photos-grouped-with-metrics]{WFPANEL-12}.%
    }
