...
\addtolength{\wpmapLabelWidth}{0.2\textwidth}

\newlength{\wpmapContentWidth}
\setlength{\wpmapContentWidth}{0.74\textwidth}

\newlength{\wpmapColTwoWidth}
\newlength{\wpmapColThreeWidth}
\newlength{\wpmapColFourWidth}
\setlength{\wpmapColTwoWidth}{0.22\textwidth}
\setlength{\wpmapColThreeWidth}{0.18\textwidth}
\setlength{\wpmapColFourWidth}{0.24\textwidth}

\newlength{\wpmapHeaderHeight}
\setlength{\wpmapHeaderHeight}{12mm}

\newlength{\wpmapTableWidth}
\setlength{\wpmapTableWidth}{\dimexpr
\wpmapLabelWidth+\wpmapColTwoWidth+\wpmapColThreeWidth+\wpmapColFourWidth\relax}
...
\newcommand{\wpmapHeaderRow}[1]{%
    \rowcolor{lightgray}%
    \multicolumn{4}{|c|}{%
        \parbox[c][\wpmapHeaderHeight][c]{\wpmapTableWidth}{%
            \centering\bfseries
            \vspace{1.2ex}%
            #1%
            \vspace{1.2ex}%
