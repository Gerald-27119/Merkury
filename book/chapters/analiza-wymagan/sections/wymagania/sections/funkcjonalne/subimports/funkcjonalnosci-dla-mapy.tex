...
{S}
{
    ...
    \wfmaprelated{\hyperref[womap:display-spots]{WOMAP-01}}
}
...
{S}
{
    ...
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{
        \hyperref[womap:display-spots]{WOMAP-01},
        \hyperref[womap:spot-details]{WOMAP-02}
    }
}
...
{S}
{
    ...
    \wfmaprelated{
        \hyperref[womap:spot-details]{WOMAP-02},
        \hyperref[womap:spot-media]{WOMAP-06}
    }
}
...
{S}
{
    ...
    \wfmaprelated{
        \hyperref[womap:spot-details]{WOMAP-02},
        \hyperref[womap:spot-comment]{WOMAP-05}
    }
}
...
{S}
{
    ...
    \wfmapstakeholder{U3}
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{\hyperref[womap:spot-comment]{WOMAP-05}}
}
...
{S}
{
    ...
    \wfmapstakeholder{U3}
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{\hyperref[womap:spot-details]{WOMAP-02}}
}
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            ...
            \item Po kliknięciu przycisku pobierana jest akutalna lokalizacja użytkownika,
    ...
    \wfmaprelated{
        \hyperref[womap:spot-details]{WOMAP-02},
        \hyperref[womap:spot-user-location]{WOMAP-07}
    }
}
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            ...
            \item W dużej galerii mediów wyświetlana jest lista wszystkich lista medii wybranego typu, przewijana przy
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi sortowanie oraz filtrowanie medii w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
            ...
            \item Po kliknięciu przyciku lista jest aktualizowana, a obecne wybrane media jest ustawiane na
            ...
            \item Domyslnie sortowanie jest po dacie dodania media, od najnowszego.
            \item Użytkownik jest informowany o błędach, które wystąpiły w trakcie operacji.
        \end{itemize}
    }
    \wfmapstakeholder{U3}
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{\hyperref[womap:spot-media]{WOMAP-06}}
}
...
{S}
{
    \wfmapdesc{System wyświetla użytkownikowi powiększone obecnie wybrane media w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
            \item Użytkownikowi wyświetlane jest obecnie wybrane media, które jest powięszkone.
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi udostępnienie obecnie wybranego media w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi polubienie obecnie wybranego media w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
            ...
            \item Gdy miedia jest polubione, kliknięcie przycisku powoduje odwrotną operację.
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi powiększenie na cały ekran obecnie wybranego media w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi pobranie obecnie wybranego media w dużej galerii mediów wybranego \glslink{spot}{spota}.}
    \wfmapaccept{
        \begin{itemize}
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            \item Po kliknięciu \glslink{spot}{spota} użytkownikowi wyświetlane są obecne dane pogodowe zawierjące:
            temperatuę, prędkość wiatru, ikonę symbolizującą stan pogody (np. zachmurzenie) oraz przycisk do
    ...
    \wfmaprelated{
        \hyperref[womap:display-spots]{WOMAP-01},
        \hyperref[womap:spot-weather]{WOMAP-03}
    }
}
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item wykres zawierjący prognozę pogody na 3 kolejne dni
            \end{itemize}
            \item Użytkownik jest informowany o błędach, które wystąpiły w podczas pobierania danych.
        \end{itemize}
    }
    \wfmapstakeholder{U3}
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{\hyperref[womap:spot-weather]{WOMAP-03}}
}
...
{S}
{
    ...
    \wfmaprelated{
        \hyperref[womap:display-spots]{WOMAP-01},
        \hyperref[womap:spot-search]{WOMAP-04}
    }
}
...
{S}
{
    ...
    \wfmapstakeholder{U3}
    \wfmapresponsible{Stanisław Oziemczuk}
    \wfmaprelated{\hyperref[womap:spot-search]{WOMAP-04}}
}
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            ...
            \item Po kliknięciu przycisku wyświetlana lista jest przewijalna przy użyciu \glslink{infinite-scroll}{nieskończonego przewiajania}.
...
{S}
{
    ...
    \wfmapaccept{
        \begin{itemize}
            ...
            \item Użytkownik może filtrować wyniki poprzez wpiane frazy.
            ...
            \item W przypadku brak pasujących wyników wyświetlany jest odpowiedni komunikat.
            \item Użytkownik jest informowany o błędach, które wystąpiły w podczas pobierania danych.
        \end{itemize}
    }
    \wfmapstakeholder{U3}
...
{S}
{
    \wfmapdesc{System umożliwia użytkownikowi zmianę przubliżenia widoku mapy.}
    \wfmapaccept{
        \begin{itemize}
