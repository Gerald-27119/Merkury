...
{S}
{
    ...
    \wffaccept{
        \begin{itemize}
            ...
            \item Każdy post zawiera tytuł, kategorie, zero lub więcej tagów, pierwsze dwieście liter treści, liczbę komentarzy oraz liczbę wyświetleń posta.
...
{S}
{
    ...
    \wffaccept{
        \begin{itemize}
            ...
            Least Viewed, Most Commented, Least Commented (Najnwosze, Najstarsze, Najwięcej wyświetleń, Najmniej wyświetleń, Najwięcej komentarzy, Najmniej komentarzy).
...
{S}
{
    ...
    \wffaccept{
        \begin{itemize}
            ...
            Most UpVoted, Most DownVoted (Najnowsze, Najstarsze, Najwyżej oceniane, Najniżej oceniane).
        \end{itemize}
    }
...
{S}
{
    ...
    \wffaccept{
        \begin{itemize}
            ...
            \item W przypadku pustej listy wyświetlany jest komunikat o braku obserwowanych postów.
        \end{itemize}
    }
...
{S}
{
    ...
    \wffaccept{
        \begin{itemize}
            \item Regulamin jest dostępny na \glslink{sidebar}{sidebarze} z poziomu forum.
        \end{itemize}
    }
