...
{S}
{
    ...
    \wflogaccept{%
        \begin{itemize}
            ...
            \item W przypadku błędnych danych lub błędu po stronie \gls{api} system wyświetla komunikat o błędzie.
        \end{itemize}
    }
...
{M}
{
    ...
    oraz zapewnić poprawność danych wysyłanych do \gls{api}.}

    \wflogaccept{%
        \begin{itemize}
            \item Formularze nie pozwalają na wysłanie pustych pól wymaganych.
            \item Każde z pól zawiera maksymalną oraz minimalną ilość znaków.
            \item Dla hasła sprawdzana jest odpowiednio silna kombinacja.
...
{M}
{
    ...
    \wflogaccept{%
        \begin{itemize}
            ...
            \item W przypadku błędu połączenia z \gls{api} użytkownik widzi komunikat o problemie technicznym.
