...
\subsubsection{Wymagania funkcjonalne dla panelu użytkonika}
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item Dane są pobierane z API i prezentowane po wejściu na podstronę profilu.
        \end{itemize}
    }
...
{S}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            \item Użytkownik może wybrać plik graficzny i zapisać nowy avatar.
            \item Po zapisaniu nowy avatar jest widoczny na profilu.
            \item W przypadku błędu zapisu lub niepoprawnego pliku system wyświetla komunikat o błędzie.
        \end{itemize}
    }
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item W przypadku braku zdjęć system wyświetla informację o braku wyników.
        \end{itemize}
    }
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item Po kliknięciu stan relacji jest aktualizowany w interfejsie („Wating For Confirmation”, „Unfollow”).
        \end{itemize}
    }
...
{M}
{
    \wfpaneldesc{System umożliwia użytkownikowi przełączanie typu listy spotów w panelu konta
    (polubione, odwiedzone i ocenione pozytywnie, odwiedzone i ocenione negatywnie, planowane).}

    \wfpanelaccept{%
        \begin{itemize}
            \item Użytkownik może wybrać kategorię listy spotów.
...
{M}
{
    \wfpaneldesc{System umożliwia użytkownikowi usunięcie spota z aktualnie wyświetlanej listy w panelu konta.}

    \wfpanelaccept{%
        \begin{itemize}
            \item Użytkownik może usunąć wybrany spot z listy.
            \item Po usunięciu spot znika z listy bez konieczności przeładowania całej strony.
        \end{itemize}
    }
...
{M}
{
    \wfpaneldesc{System udostępnia przycisk umożliwiający wyświetlenie lokalizacji wybranego spota na mapie.}

    \wfpanelaccept{%
        \begin{itemize}
            \item Dla spota na liście dostępny jest przycisk „See on map”.
...
% =========================================
% WFPANEL-16 – Sortowanie komentarzy po dacie
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-17 – Filtrowanie komentarzy po dacie
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-18 – Grupowanie komentarzy po dacie i spocie
% =========================================
\wfpanelatcard
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item W ramach grupy daty komentarze są przypisane do nazw spota.
        \end{itemize}
    }
...
% =========================================
% WFPANEL-19 – Wyświetlenie listy znajomych
% =========================================
\wfpanelatcard
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item Lista jest pobierana z API i prezentowana w sekcji społeczności.
        \end{itemize}
    }
...
% =========================================
% WFPANEL-20 – Wyświetlenie listy obserwowanych
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-21 – Wyświetlenie listy obserwujących
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-22 – Wyświetlenie listy zaproszeń
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-23 – Wyszukiwanie nowych znajomych (okno)
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-24 – Akcje na znajomym (usuń / profil / wiadomość)
% =========================================
\wfpanelatcard
...
% =========================================
% WFPANEL-25 – Lista dodanych spotów
% =========================================
\wfpanelatcard
...
{M}
{
    \wfpaneldesc{System umożliwia użytkownikowi wyświetlenie listy spotów dodanych przez niego w panelu konta.}

    \wfpanelaccept{%
        \begin{itemize}
            \item Użytkownik widzi listę własnych dodanych spotów.
            \item W przypadku braku spotów system wyświetla informację o braku wyników.
        \end{itemize}
    }
...
% =========================================
% WFPANEL-26 – Dodawanie spota formularzem
% =========================================
\wfpanelatcard
...
{M}
{
    \wfpaneldesc{System umożliwia użytkownikowi dodanie nowego spota poprzez formularz w panelu konta.}

    \wfpanelaccept{%
        \begin{itemize}
            \item Użytkownik ma dostęp do formularza dodawania spota.
            \item Użytkownik może wysłać poprawnie wypełniony formularz.
            \item W przypadku błędu walidacji lub błędu API system wyświetla komunikat.
        \end{itemize}
    }
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item W przypadku błędnych danych lub błędu API system wyświetla komunikat.
        \end{itemize}
    }
...
{M}
{
    ...
    \wfpanelaccept{%
        \begin{itemize}
            ...
            \item W przypadku błędu system wyświetla komunikat.
        \end{itemize}
    }
