...
\setlength{\wfczColTwoWidth}{0.24\textwidth}

\newlength{\wfczColThreeWidth}
\setlength{\wfczColThreeWidth}{0.16\textwidth}

\newlength{\wfczColFourWidth}
\setlength{\wfczColFourWidth}{0.38\textwidth}
...
{S}
{
    ...
    \wfczrelated{Wymaganie ogólne WOCZAT-01 (\ref{woczat:send-message}).}
}
...
{S}
{
    ...
    \wfczrelated{Wymaganie ogólne WOCZAT-04 (\ref{woczat:create-chat}).}
}
...
{S}
{
    ...
    \wfczrelated{Wymaganie ogólne WOCZAT-03 (\ref{woczat:browse-history}).}
}
...
{S}
{
    ...
    \wfczrelated{Wymaganie ogólne WOCZAT-02 (\ref{woczat:edit-chat}).}
}
