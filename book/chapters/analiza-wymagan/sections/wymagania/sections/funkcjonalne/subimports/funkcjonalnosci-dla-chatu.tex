...
{S}
{
    \wfczdesc{System umożliwia dołączanie i wysyłanie plików (dokumentów,
...
{S}
{
    ...
    \wfczaccept{%
        \begin{itemize}
            ...
            \item \gls{ui} wyraźnie wskazuje, że rozmowa to czat grupowy (nazwa, avatar, liczba uczestników).
