...
\newcommand{\wologatcard}[5]{%
    ...
    \hline
    \wologHeaderRow{\shortstack{KARTA WYMAGANIA OGÓLNEGO DLA \\ LOGOGWANIA I REJESTRACJI}}
    \endfirsthead
    \hline
    \wologHeaderRow{\shortstack{KARTA WYMAGANIA OGÓLNEGO DLA \\ LOGOGWANIA I REJESTRACJI (cd.)}}
    \endhead
