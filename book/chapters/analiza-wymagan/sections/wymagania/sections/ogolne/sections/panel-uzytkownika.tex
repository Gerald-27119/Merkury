...
{M}
{
    ...
    dodania go. Po poprawnym dodaniu użytkownik może go zobaczyć na liście własnych dodanych \glslink{spot}{spotów}.}
    \wopanustakeholder{U3}
    \wopanurelated{%
...
{M}
{
    \wopanudesc{System umożliwia użytkownikowi przeglądanie listy zdjęć dodanych przez niego
        (na forum, w \glslink{spot}{spotach} oraz w komentarzach pod \glslink{spot}{spotami}), wraz z podglądem materiałów
