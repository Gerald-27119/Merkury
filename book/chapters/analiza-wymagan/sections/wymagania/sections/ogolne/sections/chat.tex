...
{S}
{
    ...
    \woczrelated{Wymagania funkcjonalne dla czatu:
    WFCZAT-01 (\ref{wfczat:send-gif}),
        WFCZAT-02 (\ref{wfczat:send-files}),
        WFCZAT-03 (\ref{wfczat:private-messages}),
        WFCZAT-04 (\ref{wfczat:group-messages}),
        WFCZAT-06 (\ref{wfczat:emoticons}),
        WFCZAT-10 (\ref{wfczat:edit-message}).
        Wymagania pozafunkcjonalne dla czatu:
        WPCZAT-01 (\ref{wpczat:visibility-members}),
        WPCZAT-02 (\ref{wpczat:login-required}),
        WPCZAT-04 (\ref{wpczat:sender-and-time}),
        WPCZAT-06 (\ref{wpczat:send-immediately}).}
}
...
{S}
{
    ...
    \woczrelated{Wymagania funkcjonalne dla czatu:
    WFCZAT-08 (\ref{wfczat:edit-group-name}),
        WFCZAT-09 (\ref{wfczat:edit-group-avatar}),
        WFCZAT-11 (\ref{wfczat:add-users-existing-chat}).
        Wymagania pozafunkcjonalne dla czatu:
        WPCZAT-01 (\ref{wpczat:visibility-members}),
        WPCZAT-02 (\ref{wpczat:login-required}).}
}
...
{S}
{
    ...
    \woczrelated{Wymagania funkcjonalne dla czatu:
    WFCZAT-07 (\ref{wfczat:chat-availability}),
        WFCZAT-12 (\ref{wfczat:load-older-messages}).
        Wymagania pozafunkcjonalne dla czatu:
        WPCZAT-01 (\ref{wpczat:visibility-members}),
        WPCZAT-02 (\ref{wpczat:login-required}),
        WPCZAT-03 (\ref{wpczat:group-by-date}),
        WPCZAT-05 (\ref{wpczat:load-older-under-10s}).}
}
...
{S}
{
    ...
    \woczrelated{Wymaganie funkcjonalne dla czatu:
    WFCZAT-05 (\ref{wfczat:create-chat}).
    Wymagania pozafunkcjonalne dla czatu:
    WPCZAT-01 (\ref{wpczat:visibility-members}),
        WPCZAT-02 (\ref{wpczat:login-required}).}
}
