...
\newcommand{\wowyszatcard}[5]{%
    ...
    \hline
    \wopanelHeaderRow{\shortstack{KARTA WYMAGANIA OGÓLNE DLA \\ WYSZUKIWARKI SPOTÓW}}
    \endfirsthead
    \hline
    \wopanelHeaderRow{\shortstack{KARTA WYMAGANIA OGÓLNE DLA \\ WYSZUKIWARKI SPOTÓW (cd.)}}
    \endhead
