...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=1\textwidth]{attachments/wzorce-projektowe/proxy}
            \caption{Diagram klas wzorca projektowego Proxy}
            \label{fig:diagram-proxy}
        \end{figure}
        \noindent
        \item \textbf{Fasada} \textemdash \space
