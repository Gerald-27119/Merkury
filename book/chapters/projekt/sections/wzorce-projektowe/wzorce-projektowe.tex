...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Proxy} \textendash \space stosując ten \glslink{wzorzec}{wzorzec} należy stworzyć obiekt, który
        kontroluje dostęp do drogiego lub niemożliwego do duplikcji zasobu.
        Jest używany przez klienta, który chce wykonać na nim operacje.
        Obiekt poxy może zawierać dodatkową logikę, np. autoryzację klienta.
