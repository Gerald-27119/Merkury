...
\begin{itemize}
    ...
    \item \textbf{Lista spotów} - dodanych do różnych list
    (np. ulubionych, do ponownego odwiedzenia),
    \item \textbf{Lista zdjęć} – które użytkownik dodał do \glslink{spot}{spotów},
    komentarzy pod spotami oraz wpisów na forum,
    \item \textbf{Lista filmów} – które użytkownik dodał do \glslink{spot}{spotów},
    komentarzy pod spotami oraz wpisów na forum,
    \item \textbf{Znajomi} – lista znajomych,
    \item \textbf{Dodanie spota} – lista \glslink{spot}{spotów} dodanych przez użytkownika oraz formularz
...
\begin{itemize}
    ...
    \item lista obserwowanych – widok analogiczny do listy obserwujących,
    \item lista znajomych – widok analogiczny do listy obserwujących,
...
oraz \textit{Photos} (rys. \ref{img:photos-hover}).
...
oraz skomentowane (rys. \ref{img:spot-lists}).
...
\begin{figure}[H]
    ...
    \caption{Projekt strony z listą ulubionych \glslink{spot}{spotów}}
    \label{img:spot-lists}
\end{figure}

\subsubsection{Lista zdjęć}

Kolejnym widokiem jest lista zdjęć (rys. \ref{img:photos-hover}), które zostały dodane do systemu.
...
odpowiedni dla edytowanej sekcji oraz informację, który element konta
...
\begin{figure}[H]
    ...
    \caption{Projekt strony ustawień (1/2)}
    \label{img:settings}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Projekt strony ustawień (2/2)}
