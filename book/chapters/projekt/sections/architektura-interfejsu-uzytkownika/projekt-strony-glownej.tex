...
Poniżej znajduje się wyszukiwarka spotów, której układ zależy od wybranego trybu.
...
W trybie prostym przewidziano karuzelę z najpopularniejszymi spotami,
dzięki czemu możliwe jest szybkie odnalezienie interesujących miejsc bez
konieczności przeglądania całej listy wyników.

Na dole strony umieszczono listę wyszukanych spotów.
Każdy kafelek reprezentujący spot zawiera następujące informacje:
\begin{itemize}
    ...
    \item listę tagów opisujących spot,
    \item przycisk przejścia do widoku szczegółów,
    \item przycisk wyświetlenia spota na mapie wraz z informacją o
...
elementami interfejsu aplikacji.
