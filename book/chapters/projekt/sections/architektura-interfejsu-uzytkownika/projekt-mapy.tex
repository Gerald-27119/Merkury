...
\begin{itemize}
    \item ogólną (rys. \ref{fig:map-general})
    \item ze zmniejszoną szczegółowością (rys. \ref{fig:map-less-details})
    \item strefami lotów \glslink{PANSA}{PANSA} (rys. \ref{fig:map-pansa})
\end{itemize}
