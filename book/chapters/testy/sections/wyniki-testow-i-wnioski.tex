...
w tym obsługę przypadków brzegowych oraz walidację danych wejściowych. Testy integracyjne
umożliwiły potwierdzenie współpracy większych fragmentów systemu, w szczególności przepływu danych
pomiędzy komponentami oraz reakcji aplikacji na działania użytkownika (np. zmianę stanu po interakcji).
Z kolei testy E2E, uruchamiane w środowisku zbliżonym do rzeczywistego, potwierdziły poprawną realizację
pełnych scenariuszy użytkownika, obejmujących m.in. logowanie, edycję ustawień konta, przeglądanie treści
