...
\newglossaryentry{hook}{
    name={Hook (React)},
    description={Prosta funkcja w React, która „dodaje” możliwości do elementu interfejsu — np. pozwala mu coś zapamiętać (stan) albo zrobić coś po zmianie/załadowaniu. Wszystkie hooki zaczyna się od \texttt{use...} (np. \texttt{useState}, \texttt{useEffect}).}
}
