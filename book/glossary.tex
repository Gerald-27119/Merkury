...
\newglossaryentry{kontekst}{
    name={Kontekst (React)},
    description={Mechanizm w React pozwalający udostępnić wspólny obiekt (np. serwis WebSocket) wielu komponentom bez przekazywania go przez propsy.}
}
...
\newglossaryentry{montowanie}{
    name={montowanie},
    description={Moment „podpięcia” komponentu do drzewa UI (pierwsze wyrenderowanie i inicjalizacja)}
}

\newglossaryentry{odmontowanie}{
    name={odmontowanie},
    description={Usunięcie komponentu z drzewa UI (moment zwalniania zasobów i zdejmowania subskrypcji)}
}
