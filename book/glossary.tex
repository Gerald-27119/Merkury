...
\newglossaryentry{integraion-tests}
{
    name={testy integracyjne},
    description={Testy sprawdzające, czy połączone ze sobą moduły/komponenty systemu współpracują ze sobą poprawnie w warunkach zbliżonych do rzeczywistego działania aplikacji.}
}
