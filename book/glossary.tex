...
\newglossaryentry{websocket}
{
    ...
    działających „na żywo”}
}

\newglossaryentry{react-query}
{
    name={React Query},
    description={Dawna nazwa biblioteki TanStack Query. Biblioteka dla Reacta
    wspierająca pobieranie, cachowanie i synchronizację danych z API oraz obsługę
    stanów ładowania i błędów w komponentach}
}
...
\newglossaryentry{prz2}
{
    ...
    dokońćzono prace nad pracą inżynierską. Pan Adam Ubranowicz jako promotor doradzał zespołowi projektowemu.}
}
...
\newglossaryentry{psem}
{
    ...
    dokończono wytwarzaniae dokumentacji.}
}
