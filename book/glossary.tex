...
\newglossaryentry{csrf}{
    name={CSRF},
    description={Rodzaj ataku polegający na nakłonieniu przeglądarki zalogowanego użytkownika do wykonania niechcianego żądania. Mechanizmy CSRF ograniczają takie scenariusze}
}
...
\newglossaryentry{json}{
    name={JSON},
    description={Format zapisu danych tekstowych w postaci par klucz--wartość, powszechnie używany w komunikacji aplikacji webowych}
}
