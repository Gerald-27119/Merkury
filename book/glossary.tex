...
\newglossaryentry{mutacja}{
    name={Mutacja},
    description={W TanStack Query: asynchroniczna operacja modyfikująca stan danych po stronie serwera
    (utworzenie/aktualizacja/usunięcie), zwykle realizowana wywołaniem API (POST/PUT/PATCH/DELETE);
    przeciwieństwo zapytania (query) służącego do odczytu.}
}
