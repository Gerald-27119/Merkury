...
\newglossaryentry{merge}{
    name={Merge},
    description={Proces scalania zmian z jednej gałęzi do innej (z gałęzi funkcjonalnej do \texttt{develop}
    lub \texttt{master}). Scalenie integruje historię commitów oraz może wymagać rozwiązania konfliktów,
    jeśli zmiany dotyczą tych samych fragmentów kodu.}
}
