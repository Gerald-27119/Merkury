...
{
    name={Slug},
    description={Przyjazny dla użytkownika fragment adresu URL, zwykle oparty na tytule \newline (np. \texttt{/post/jak-zaczac-latac-dronem}), ułatwiający identyfikację treści i pozycjonowanie w wyszukiwarkach}
}
...
\newglossaryentry{tiptap}{
    name={Tiptap},
    description={Nowoczesny, rozszerzalny edytor \textit{rich text} dla aplikacji webowych oparty na silniku ProseMirror.
    Umożliwia budowanie rozbudowanych, modularnych edytorów treści, np. do postów na forum}
}
...
\newglossaryentry{mail-trap}{
    name={MailTrap},
    description={Usługa do testowania i przechwytywania wiadomości e-mail wysyłanych z aplikacji w środowisku deweloperskim}
}

\newglossaryentry{react-select}{
    name={react-select},
    description={\glslink{biblioteka}{Biblioteka} React służąca do tworzenia zaawansowanych \glslink{react-component}{komponentów}
    wyboru (\textit{select}), wspierająca wyszukiwanie, wybór pojedynczy i wielokrotny, filtrowanie, grupowanie opcji oraz dostosowywanie wyglądu}
}

\newglossaryentry{react-portal}{
    name={react-portal},
    description={Mechanizm \glslink{biblioteka}{biblioteki} React umożliwiający renderowanie komponentów
    poza hierarchią \glslink{dom}{DOM} \glslink{react-component}{komponentu} nadrzędnego}
    description={Usługa do testowania i przechwytywania wiadomości e-mail wysyłanych z aplikacji w środowisku deweloperskim}
}

\newglossaryentry{crud}{
    name={CRUD},
    description={Akronim od Create, Read, Update, Delete, określający podstawowe operacje wykonywane na danych w systemach informatycznych}
}

\newglossaryentry{rekurencja}{
    name={Rekurencja},
    description={Technika programistyczna polegająca na odwołaniu się funkcji
    do samej siebie w celu rozwiązania problemu poprzez podział na mniejsze
    podproblemy}
}

\newglossaryentry{ux}{
    name={UX},
    description={Doświadczenie użytkownika (ang. User Experience), całokształt wrażeń użytkownika
    wynikających z interakcji z aplikacją}
}
\newglossaryentry{asynchroniczność}{
