...
\newglossaryentry{debounce}{
    name={Debounce},
    description={Technika programistyczna polegająca na ograniczaniu liczby wywołań funkcji poprzez jej uruchomienie dopiero po upływie zadanego czasu od ostatniego wyzwolenia zdarzenia.}
}

\newglossaryentry{mutacja}{
    name={Mutacja},
    description={Operacja polegająca na zmianie istniejącego stanu lub danych w miejscu, np. poprzez modyfikację pól obiektu zamiast tworzenia jego nowej kopii.}
}
