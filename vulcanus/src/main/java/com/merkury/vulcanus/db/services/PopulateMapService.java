...
public class PopulateMapService {
    ...
    public void initMapData() {
        ...
        List<SpotMedia> spotMedia1 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/8d00d2e1-203e-4b90-bf0b-893f77f870ee.JPG", "pomnik", "pomnik", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot1, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/1299333c-ad54-4a2a-b6dc-4578ed4327dc.jpg", "pomnik", "pomnik", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 1, 15), user, spot1, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/299fd24d-2436-4b51-bfdf-cbe728890198.jpg", "pomnik", "pomnik", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot1, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/98946961-ccce-4bbc-bd78-38df283297e3.jpg", "pomnik", "pomnik", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot1, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/f87aa3e3-fbc4-4371-837d-d10a4b6878a1.jpg", "pomnik", "pomnik", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 1, 15), user, spot1, new HashSet<>())
        );

        List<SpotMedia> spotMedia2 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/b9744843-8cca-4e65-b677-bc89fbed9deb.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/562487b0-a975-4293-8c0f-aaa605f6cd77.JPG", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/04bfa588-77c3-4e46-bdf8-f6bb677f845d.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/b6d1364b-97d8-4bf1-b279-12664ac274fb.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/be341380-eb45-416e-bf60-0e80fed250bf.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/f5e1a392-a768-4f9e-9b30-98f1a01c48ae.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/9eeb8808-6165-4a9d-a864-9f11b5588b69.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/5f1ff331-eb5f-49a9-b57d-0aeed0d42eb7.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/f7b1009b-7762-4027-8b49-e789531e7cf4.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/32628ec1-ecc2-473a-b41d-14a9ff3e5d3d.jpg", "skwer", "skwer", 0, 0, GenericMediaType.PHOTO, LocalDate.of(2024, 1, 15),user, spot2, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/9c32943b-5e06-4beb-a978-dc7c835f26db.mp4", "skwer_video", "skwer", 0, 0, GenericMediaType.VIDEO, LocalDate.of(2024, 1, 15),user, spot2,new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/0206d58b-6b7a-419a-8f3e-1974463e7829.mp4", "skwer_video", "skwer", 0, 0, GenericMediaType.VIDEO, LocalDate.of(2024, 1, 15),user, spot2,new HashSet<>())
        );

        List<SpotMedia> spotMedia3 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/800413ea-ba4b-4b95-ae79-2bdaea17ce21.jpg", "park wałowy", "park wałowy", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 1, 15), user, spot3, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/91739137-cbb4-4e1e-9f61-1b9589b7a1ca.jpg", "park wałowy", "park wałowy", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 1, 15), user, spot3, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/41e751cd-7029-43cf-b9b4-bca30fa8ab90.jpg", "park wałowy", "park wałowy", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 1, 15), user, spot3, new HashSet<>())
        );

        List<SpotMedia> spotMedia4 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/777e20d5-a5cc-4811-97e0-c70d2fbc3b7a.jpg", "park", "park", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot4, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/60ac5562-29af-477a-bf86-8cb798c7f51b.jpg", "park", "park", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot4, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/d64b7781-b188-4d0a-af33-95268b81d751.JPG", "park", "park", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot4, new HashSet<>())
        );

        List<SpotMedia> spotMedia5 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/77342dd9-daab-4e05-8aed-272907d94dc8.jpg", "jar", "jar", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot5, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/6f58c6e0-1990-4855-b9ca-6418c5879e31.jpg", "jar", "jar", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot5, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/e3b361a5-4b25-41b9-a1b2-0c4d8db70afb.JPG", "jar", "jar", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot5, new HashSet<>())
        );

        List<SpotMedia> spotMedia6 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/18ff9b26-feef-4a53-b4df-64eba49e0075.jpg", "plac kobzdeja", "plac kobzdeja", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot6, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/16a82ce9-d6b4-4740-8b5e-55b27919f486.jpg", "plac kobzdeja", "plac kobzdeja", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot6, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/0dbe602d-d362-4335-a5a6-4b79267980df.JPG", "plac kobzdeja", "plac kobzdeja", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 4, 1), user, spot6, new HashSet<>())
        );

        List<SpotMedia> spotMedia7 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/c3915c65-6cc3-466f-bf0d-0b1d7644cb84.jpg", "wrona", "wrona", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot7, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/f7dd6f39-6a64-4812-8c2c-467546dcab05.jpg", "wrona", "wrona", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot7, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/023fe242-49ef-4d6e-b4ad-b43d3ece8188.jpg", "wrona", "wrona", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot7, new HashSet<>())
        );

        List<SpotMedia> spotMedia8 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/faa462f9-4582-459e-8de1-6fa8d7df34ed.jpg", "plaża", "plaża", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot8, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/c9559f6d-7a03-432b-839b-7d0875db39ff.jpg", "plaża", "plaża", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot8, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/dc0ca9b3-fecc-445f-b592-42b9ca13924c.jpg", "plaża", "plaża", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot8, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/a60e0d2a-4966-4bd5-a949-990a2babc261.jpg", "plaża", "plaża", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot8, new HashSet<>())
        );

        List<SpotMedia> spotMedia9 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/dc2a4d50-e450-4a2a-af97-9f96c4ea4e9a.jpg", "orunia", "orunia", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot9, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/65b0b74d-9172-4005-a699-eb01b52c3b5f.jpg", "orunia", "orunia", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot9, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/84cd9748-2ce4-466d-8ce4-a2adeb341e9c.jpg", "orunia", "orunia", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 7, 5), user, spot9, new HashSet<>())
        );

        List<SpotMedia> spotMedia10 = Arrays.asList(
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/5566b23d-a037-4b44-b98e-e4a76fc7cfe0.jpg", "workout", "workout", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 10, 10), user, spot10, new HashSet<>()),
                new SpotMedia(null, "https://merkurystorage.blob.core.windows.net/mapa/4cc317db-8d8a-4514-9688-bd60a1f74af0.jpg", "workout", "workout", 0, 0, GenericMediaType.PHOTO,LocalDate.of(2024, 10, 10), user, spot10, new HashSet<>())
        );
